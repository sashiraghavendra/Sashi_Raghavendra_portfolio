      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left mb-14 space-y-2">
          <h2 className="font-display font-medium text-3xl sm:text-4xl text-white tracking-tight">
            Credentials & <span className="font-bold text-glow text-brand-cyan">Certifications</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {certifications.map((cert, idx) => (
              <div
                key={idx}
                className="glass-pane border border-white/5 rounded-2xl p-5 sm:p-6 hover:border-brand-cyan/35 hover:shadow-[0_0_20px_rgba(6,182,212,0.05)] transition-all duration-300 flex flex-col justify-between space-y-5"
              >
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-gray-400 font-mono">
                    Issuer: <span className="text-gray-300 font-medium">{cert.issuer}</span>
                  </p>
                </div>

                <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                  <span className="text-[10px] font-mono text-gray-400">100% Authorized</span>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="glass-pane border border-white/5 rounded-2xl p-6 bg-gradient-to-tr from-brand-cyan/[0.03] via-slate-950/80 to-transparent flex flex-col gap-5 hover:border-brand-cyan/25 transition-all duration-300">
              ...
              <div className="space-y-4">
                <div className="p-3 bg-slate-900/60 border border-white/5 rounded-xl space-y-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="font-mono text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Full Academic Honors</span>
                  </div>
                ...
                <div className="p-3 bg-slate-900/60 border border-white/5 rounded-xl space-y-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="font-mono text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Infosys Springboard 6.0</span>
                  </div>
                  <p className="text-xs text-gray-300 font-light">
                ...
                <div className="p-3 bg-slate-900/60 border border-white/5 rounded-xl space-y-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="font-mono text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Double Platform Honors</span>
                  </div>
                  <p className="text-xs text-gray-300 font-light">
              ...
              <div className="pt-2 text-[9px] font-mono text-gray-500 uppercase tracking-widest leading-none">
